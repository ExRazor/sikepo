<div id="modal-export-research" class="modal fade effect-slide-in-right">
    <form action="{{route('research.export')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content bd-0 tx-14 modal-form">
                <div class="modal-header pd-y-20 pd-x-25">
                    <h6 class="tx-16 mg-b-0 tx-uppercase tx-inverse tx-bold">Ekspor Data Penelitian</h6>
...
<script>
    ...
    $('#modal-export-research').on('change','input[name=tipe]',function(){
        var cont            = $('#modal-export-research');
    ...
    $('#modal-export-research').on('hidden.bs.modal', function () {
