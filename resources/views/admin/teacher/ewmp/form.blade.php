<div id="ewmp-form" class="modal fade effect-slide-in-right">
        <form id="form-ewmp" method="POST" enctype="multipart/form-data">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content bd-0 tx-14 modal-form">
                    <div class="modal-header pd-y-20 pd-x-25">
                        <h6 class="tx-16 mg-b-0 tx-uppercase tx-inverse tx-bold title-ewmp">Tambah Waktu Mengajar</h6>
                    ...
                    <div class="modal-body pd-20">
                        ...
                        <div class="form-group row mg-t-20">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="hidden" name="_nidn" value="{{encrypt($data->nidn)}}">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" id="btn-save-ewmp" value="post">
                            Simpan
                        </button>
