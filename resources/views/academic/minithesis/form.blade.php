...
<div class="br-pageheader">
    <nav class="breadcrumb pd-0 mg-0 tx-12">
        @foreach (Breadcrumbs::generate( isset($data) ? 'academic-minithesis-edit' : 'academic-minithesis-create', isset($data) ? $data : '' ) as $breadcrumb)
...
<div class="br-pagebody">
    ...
    <div class="widget-2">
        <div class="card mb-3">
            <form id="research_form" action="@isset($data) {{route('academic.minithesis.update',$data->id)}} @else {{route('academic.minithesis.store')}} @endisset" method="POST" enctype="multipart/form-data" data-parsley-validate>
                <div class="card-body bd bd-y-0 bd-color-gray-lighter">
                    <div class="row">
                        <div class="col-md-9 mx-auto">
                            ...
                            <div class="row mb-3">
                                <label class="col-md-3 form-control-label">Judul Tugas Akhir: <span class="tx-danger">*</span></label>
                                <div class="col-md-8">
                            ...
                            <div class="row mb-3">
                                <label class="col-md-3 form-control-label">Tahun Diangkat: <span class="tx-danger">*</span></label>
                                <div class="col-md-8">
