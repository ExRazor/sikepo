...
<div id="persentase_dtps_jabatan" class="card shadow-base mb-3">
    <div class="card-header">
        <div class="card-title">
            <h6 class="mg-b-0">
                Persentase DTPS Guru Besar & Lektor Kepala
            </h6>
        </div>
        <div class="ml-auto">
...
<div id="persentase_dtps_sertifikat" class="card shadow-base mb-3">
    <div class="card-header">
        <div class="card-title">
            <h6 class="mg-b-0">
                Persentase DTPS Bersertifikat
            </h6>
        </div>
        <div class="ml-auto">
            <button class="btn btn-sm btn-primary btn-add" data-toggle="modal" data-target="#simulasi-dtps-bersertifikat"><i class="fa fa-sync mg-r-10"></i> Simulasi</button>
        </div>
    </div>
    <div class="card-body bd-color-gray-lighter">
        <form class="form-perhitungan">
