            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="pembimbing_utama" disabled>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Pembimbing dengan Jumlah Bimbingan <= 10</label>
                        <input type="text" class="form-control" id="pembimbing_10" disabled>
                    </div>
                </div>
            </div>
            <div class="row">
...
<div id="waktu_mengajar" class="card shadow-base mb-3">
    <div class="card-header">
        ...
        <div class="ml-auto">
            <button class="btn btn-sm btn-primary btn-add" data-toggle="modal" data-target="#simulasi-swmp-dtps"><i class="fa fa-sync mg-r-10"></i> Simulasi</button>
        </div>
    </div>
    <div class="card-body bd-color-gray-lighter">
        <form class="form-perhitungan">
            ...
            <div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="dtps_prestasi_inter" disabled>
					</div>
				</div>
			</div>
			<div class="row">
