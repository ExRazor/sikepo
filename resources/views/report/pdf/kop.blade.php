<table align="center" class="kop-surat">
    <tr>
        <td class="logo">
                <img class="w-100" src="{{ asset ('assets/images/logo-ung-bw.png') }}">
        </td>
        <td class="text">
            <table>
                <tr><td class="caps">KEMENTERIAN PENDIDIKAN DAN KEBUDAYAAN</td></tr>
                <tr><td class="caps">UNIVERSITAS NEGERI GORONTALO</td></tr>
