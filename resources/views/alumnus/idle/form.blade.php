            ...
            <div class="modal-content bd-0 tx-14 modal-form">
                ...
                <div class="modal-body pd-20">
                    ...
                    <div class="form-group row mg-t-20">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control disabled" name="kriteria_1" placeholder="Isikan jumlah lulusan dengan Waktu Tunggu < 6 bulan">
                        </div>
                    </div>
                    <div class="form-group row mg-t-20">
                        <label class="col-sm-3 form-control-label"><span class="tx-danger">*</span>WT 6-18 bulan:</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="kriteria_2" placeholder="Isikan jumlah lulusan dengan 6 bulan ≤ Waktu Tunggu ≤ 18 bulan" required>
                        </div>
                    </div>
                    <div class="form-group row mg-t-20">
                            <label class="col-sm-3 form-control-label"><span class="tx-danger">*</span>WT > 18 bulan:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kriteria_3" placeholder="Isikan jumlah lulusan dengan Waktu Tunggu > 18 bulan" required>
                            </div>
                        </div>
                </div>
