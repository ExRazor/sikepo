...
<div class="br-pagetitle">
    ...
    <div class="ml-auto">
        <a href="{{ route('output-activity.teacher.create') }}" class="btn btn-teal btn-block mg-b-10" style="color:white"><i class="fa fa-plus mg-r-10"></i> Luaran</a>
    </div>
    @endif
</div>
    ...
    <div class="widget-2">
        <div class="card shadow-base mb-3">
            ...
            <div class="card-body bd-color-gray-lighter">
                <table id="table_outputActivity_teacher" class="table display responsive" data-order='[[ 3, "desc" ]]' data-page-length="25" url-target="{{route('ajax.output-activity.teacher.datatable')}}">
                    <thead>
                        <tr>
...
<script type="text/javascript">
    var table = $('#table_outputActivity_teacher');
    datatable(table);
