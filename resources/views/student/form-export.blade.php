<div id="modal-export-student" class="modal fade effect-slide-in-right">
    <form action="{{route('student.list.export')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content bd-0 tx-14 modal-form">
                <div class="modal-header pd-y-20 pd-x-25">
                    <h6 class="tx-16 mg-b-0 tx-uppercase tx-inverse tx-bold">Ekspor Data Mahasiswa</h6>
