                    ...
                    <div class="row">
                        <div class="col-9 mx-auto">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-8">
                                    <input class="form-control" type="text" name="judul" value="{{ isset($data) ? $data->judul : old('judul')}}" placeholder="Contoh: Permasalahan Permukiman Perdesaan Di Indonesia: Kajian geografi Permukiman" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-3 form-control-label">Penerbit: <span class="tx-danger">*</span></label>
                                <div class="col-8">
                                    <input class="form-control" type="text" name="penerbit" value="{{ isset($data) ? $data->penerbit : old('penerbit')}}" placeholder="Contoh: Kenangan Press" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-8">
                                    <label class="ckbox ckbox-inline mb-0 mr-4">
                                        <input name="sesuai_prodi" type="checkbox" value="1" {{ isset($data) && isset($data->sesuai_prodi) || old('sesuai_prodi')=='1' ? 'checked' : ''}}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-8">
                                    <input class="form-control" type="text" name="jurnal" value="{{ isset($data) ? $data->jurnal : old('jurnal')}}" placeholder="Contoh: Asian Social Science Vol.9, No.12">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-3 form-control-label">Jumlah Sitasi:</label>
                                <div class="col-8">
                                    <input class="form-control number" type="text" name="sitasi" value="{{ isset($data) ? $data->sitasi : old('sitasi')}}" placeholder="Masukkan jumlah sitasi">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-3 form-control-label">Akreditasi:</label>
                                <div class="col-8">
                                    <input class="form-control" type="text" name="akreditasi" value="{{ isset($data) ? $data->akreditasi : old('akreditasi')}}" placeholder="Jika belum terakreditasi, dikosongkan saja">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-3 form-control-label">Tautan:</label>
                                <div class="col-8">
                                    <input class="form-control" type="text" name="tautan" value="{{ isset($data) ? $data->tautan : old('tautan')}}" placeholder="Jika belum ada tautan digital, dikosongkan saja">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row mb-3 justify-content-center align-items-center">
                                    <div class="col-md-3 mb-3">
                                        <select class="form-control mb-2" name="status_penulis" id="status_penulis" onchange="form_penulis()" required>
                                            ...
                                            <option value="Sendiri" {{ (isset($data) && $data->penulisUtama->nidn==auth()->user()->username) || old('status_penulis') == 'Sendiri' ? 'selected' : '' }}>Sendiri</option>
                                            <option value="Dosen" {{ (isset($data) && $data->penulisUtama->status=='Dosen' && $data->penulisUtama->nidn!=auth()->user()->username) || old('status_penulis') == 'Dosen' ? 'selected' : '' }}>Dosen Jurusan</option>
                                    ...
                                    <div class="col-md-3 mb-3 tipe-dosen" style="{{ isset($data) && $data->penulisUtama->status=='Dosen' && $data->penulisUtama->nidn != auth()->user()->username ? '' : 'display:none;' }}">
                                        <input class="form-control" type="text" name="penulis_nidn" value="{{ isset($data) && $data->penulisUtama->nidn!=auth()->user()->username ? $data->penulisUtama->nidn : Request::old('penulis_nidn')}}" placeholder="NIDN" {{ isset($data) && $data->penulisUtama->status=='Dosen' ? 'required' : '' }}>
                                    </div>
