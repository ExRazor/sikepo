            ...
            <div class="modal-content bd-0 tx-14 modal-form">
                ...
                <div class="modal-body pd-20">
                    ...
                    <div class="form-group row mg-t-20">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="penelitian" placeholder="Jumlah SKS pada Bidang Penelitian" disabled>
                        </div>
                    </div>
                    <div class="form-group row mg-t-20">
                        <label class="col-sm-3 form-control-label"><span class="tx-danger">*</span> SKS Pengabdian:</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="pkm" placeholder="Jumlah SKS pada Bidang Pengabdian/PKM" disabled>
                        </div>
                    </div>
                    <div class="form-group row mg-t-20">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium btn-save" value="post" data-dest="{{route('profile.ewmp.store')}}">
                        Simpan
                    </button>
