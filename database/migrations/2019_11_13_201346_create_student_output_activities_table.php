...
class CreateStudentOutputActivitiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('student_output_activities', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('student_output_activities');
    }
}
