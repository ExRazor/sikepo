...
class AlumnusWorkplaceSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        foreach($academicYear as $ay) {
            foreach($studyProgram as $sp) {
                ...
                DB::table('alumnus_workplaces')->insert([
                    'kd_prodi'              => $sp->kd_prodi,
                    'tahun_lulus'           => $ay->tahun_akademik,
                    'jumlah_lulusan'        => $lulusan,
                    'lulusan_bekerja'       => $terlacak,
                    'kerja_lokal'           => $kriteria_1,
                    'kerja_nasional'        => $kriteria_2,
                    'kerja_internasional'   => $kriteria_3,
                    'created_at'            => now()
                ]);
            }
        }
