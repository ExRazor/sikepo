...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('student')->name('student.')->middleware('role:admin,kaprodi,kajur')->group(function () {
        ...
        Route::post('list/import', 'StudentController@import')->name('list.import');
    ...
    Route::prefix('assessment')->name('assessment.')->group(function () {
        ...
        Route::post('student/publikasi', 'Perhitungan\MahasiswaController@publikasi_mhs');
        Route::post('student/luaran', 'Perhitungan\MahasiswaController@luaran_mhs');
        ...
        Route::post('resource/penelitian', 'Perhitungan\SdmController@penelitian_dtps');
        Route::post('resource/pengabdian', 'Perhitungan\SdmController@pengabdian_dtps');
        Route::post('resource/publikasi', 'Perhitungan\SdmController@publikasi_dtps');
        ...
        Route::post('tridharma/prestasi_mahasiswa/akademik', 'Perhitungan\TridharmaController@prestasi_akademik_mahasiswa');
        Route::post('tridharma/prestasi_mahasiswa/nonakademik', 'Perhitungan\TridharmaController@prestasi_nonakademik_mahasiswa');
        Route::post('tridharma/masa_studi_lulusan', 'Perhitungan\TridharmaController@masa_studi_lulusan');
