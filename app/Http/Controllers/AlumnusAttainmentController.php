        ...
        foreach ($studyProgram as $sp) {
            foreach ($academicYear as $ay) {
                ...
                foreach ($q as $lulusan) {
                    $masa_studi[$lulusan->nim] = $ay->tahun_akademik - $lulusan->student->angkatan;
                }
                ...
                $rata_masa_studi[$sp->kd_prodi][$ay->tahun_akademik] = count($masa_studi) > 0 ? array_sum($masa_studi) / count($masa_studi) : 0;
            }
        }
