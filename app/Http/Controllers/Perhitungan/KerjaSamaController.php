...
class KerjaSamaController extends Controller
{
    ...
    public function kerjasama(Request $request)
    {
        ...
        //Cek hitung query atau simulasi
        if (!$request->post('simulasi')) {
            ...
            $jumlah = array(
                'dtps'          => $request->input('sim_dosen'),
                'pendidikan'    => $request->input('sim_pendidikan'),
                'penelitian'    => $request->input('sim_penelitian'),
                'pengabdian'    => $request->input('sim_pkm'),
                'internasional' => $request->input('sim_internasional'),
                'nasional'      => $request->input('sim_nasional'),
                'lokal'         => $request->input('sim_lokal'),
            );
        }

        //Hitung
        $data = $this->hitung_kerjasama($jumlah);
    ...
    public function hitung_kerjasama($jumlah)
    {
        //Faktor
        $faktor_jenis = array(
            'a' => 3,
